...
build:
	...
	go build -o mchain -ldflags="\
    	-X 'github.com/meerkat-chain/mchain/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/meerkat-chain/mchain/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/meerkat-chain/mchain/versioning.Branch=$(BRANCH)'\
		-X 'github.com/meerkat-chain/mchain/versioning.BuildTime=$(TIME)'" \
	main.go
...
test-e2e:
	...
	go build -race -o artifacts/mchain .
	env EDGE_BINARY=${PWD}/artifacts/mchain go test -v -timeout=30m ./e2e/...
